...
const OrderCard = ({ order }) => {
  ...
  const getStatusStyle = (status) => {
    ...
    if (s === "delivered")
      return { bg: "#f0fdf4", color: "#16a34a", border: "#bcf0da" };
    if (s === "cancelled")
  ...
  return (
    ...
    >
      <Card.Body className="p-0 pb-4">
        <div
          className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 p-2"
        ...
        >
          ...
          <div
            className="px-2 py-1 fw-bold align-self-start align-self-md-center"
            style={{
              fontSize: "10px",
        ...
        <Row className="align-items-center px-2">
          <Col xs={12} md={8}>
            ...
            <div
              ...
              style={{ fontSize: "13px" }}
            >
              {(order.items?.[0]?.name || "Product details unavailable").slice(
                0,
                60,
              )}
          ...
          <Col xs={12} md={4} className="text-start text-md-end mt-3 mt-md-0">
            ...
            >
              VIEW DETAILS
              <span className="material-symbols-outlined align-middle fs-6 ms-1">
                chevron_right
              </span>
            </Button>
          </Col>
