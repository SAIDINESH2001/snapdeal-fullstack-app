...
const AccountSidebar = ({ user }) => {
  return (
    <div className="border-md-end border-bottom border-md-bottom-0 pb-3 pb-md-0 pr-md-4 h-100">
      <h5
        className="fw-bold mb-3 mb-md-4"
        style={{ fontSize: "14px", color: "#e40046", letterSpacing: "0.5px" }}
      >
        MY ACCOUNT
      </h5>

      <div
        className="d-flex align-items-center gap-3 mb-4 p-2"
      ...
      <div className="mb-4">
        ...
        <div
          ...
          style={{ fontSize: "12px", color: "#e40046", cursor: "pointer" }}
        >
          My Orders
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div
          className="ps-4 text-muted py-1 cursor-pointer"
          style={{ fontSize: "12px" }}
        >
          Saved Addresses
        </div>
