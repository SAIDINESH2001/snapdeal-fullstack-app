        ...
        <div className="d-flex justify-content-between align-items-center h-100 px-2">
          ...
          <div className="d-flex align-items-center">
            {topInfoItems.map((item) => {
              return (
                <Link to={item.path} className="d-flex text-decoration-none align-items-center justify-content-start ms-4 text-dark" key={item} target="_blank">
                    <span class="material-symbols-outlined">{item.svgName}</span>
